...
I saw a [fantastic presentation by Preethi Kasireddy](https://youtu.be/S8HXkEnA48g?t=4h51m45s) which compares **Mobx** with **Redux**. The reason I think the presentation is so good is because it nails the nature of application development and compares two very different approaches with their benefits and challenges. I will piggyback on this presentation, adding Cerebral to the mix so you can see where it fits in. If you do not know Mobx or Redux I suggest you keep reading on as the code examples are quite simple and the concepts will matter to you no matter what framework you use. You might even find some approaches or tools you want to bring back to your existing framework and community. Please do, that is what open source is all about :-)

## Learning curve
Every framework has new idioms, these being framework APIs and use of new JS APIs and patterns. This, in combination with the amount of "magic" introduced, affects the learning curve. Familiar code and magical code make a framework easier to learn. Angular introduced plenty of magic when it was released and many developers were dazzled by how easily you could make an input sync with some text on the page. But easy code does not mean code that is easy to scale and maintain; it is often in direct contradiction.
