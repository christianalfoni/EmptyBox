...
Page('/articles/2016_03_27_Creating-apps-with-observables', function (req) {
  ...
  store.commit();
  require.ensure(['./../drafts/2016_03_27_Creating-apps-with-observables.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2016_03_27_Creating-apps-with-observables.md');
