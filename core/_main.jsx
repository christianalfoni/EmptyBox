...
Page('/articles/2015_05_12_Cerebral-developer-preview', function (req) {
  document.body.classList.add('article-loading');
  store.set('loadingArticle', '/articles/2015_05_12_Cerebral-developer-preview');
  store.commit();
  require.ensure(['./../drafts/2015_05_12_Cerebral-developer-preview.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2015_05_12_Cerebral-developer-preview.md');
    store.select('articles', {file: '2015_05_12_Cerebral-developer-preview.md'}).edit(parseArticle('2015_05_12_Cerebral-developer-preview.md', content));
    if (store.select('currentArticle').get() !== '2015_05_12_Cerebral-developer-preview.md') { document.body.scrollTop = 0; }
    store.set('currentArticle', '2015_05_12_Cerebral-developer-preview.md');
    store.set('currentRoute', '/articles/2015_05_12_Cerebral-developer-preview');
...
if (module.hot) {
    module.hot.accept(["./../drafts/2015_05_12_Cerebral-developer-preview.md","./../posts/2015_04_26_Handling-complex-state-with-Baobab.md","./../posts/2015_04_19_The-ultimate-webpack-setup.md","./../posts/2015_04_01_Functional-Reactive-Applications.md","./../posts/2015_03_01_True-isomorphic-apps-with-React-and-Baobab.md","./../posts/2015_02_22_The-great-Angular-component-experiment.md","./../posts/2015_02_06_Plant-a-Baobab-tree-in-your-flux-application.md","./../posts/2015_01_01_Think-twice-about-ES6-classes.md","./../posts/2014_12_13_Webpack-and-react-is-awesome.md","./../posts/2014_10_30_A-browserify-workflow-part-2.md","./../posts/2014_10_22_Nailing-that-validation-with-React-JS.md","./../posts/2014_08_29_Choosing-the-correct-packaging-tool-for-React-js.md","./../posts/2014_08_20_React-js-and-flux.md"], function () {
