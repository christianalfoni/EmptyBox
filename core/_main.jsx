...
Page('/articles/2015_09_22_Introducing-Cerebral', function (req) {
  ...
  store.commit();
  require.ensure(['./../drafts/2015_09_22_Introducing-Cerebral.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2015_09_22_Introducing-Cerebral.md');
