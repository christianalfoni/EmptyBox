...
Page('/articles/2015_10_01_Taking-the-next-step-with-react-and-webpack', function (req) {
  ...
  store.commit();
  require.ensure(['./../drafts/2015_10_01_Taking-the-next-step-with-react-and-webpack.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2015_10_01_Taking-the-next-step-with-react-and-webpack.md');
