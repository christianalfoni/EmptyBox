...
Page('/articles/2016_04_17_Combining-React-with-industrial-design', function (req) {
  document.body.classList.add('article-loading');
  store.set('loadingArticle', '/articles/2016_04_17_Combining-React-with-industrial-design');
  store.commit();
  require.ensure(['./../drafts/2016_04_17_Combining-React-with-industrial-design.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2016_04_17_Combining-React-with-industrial-design.md');
    store.select('articles', {file: '2016_04_17_Combining-React-with-industrial-design.md'}).edit(parseArticle('2016_04_17_Combining-React-with-industrial-design.md', content));
    if (store.select('currentArticle').get() !== '2016_04_17_Combining-React-with-industrial-design.md') { document.body.scrollTop = 0; }
    store.set('currentArticle', '2016_04_17_Combining-React-with-industrial-design.md');
    store.set('currentRoute', '/articles/2016_04_17_Combining-React-with-industrial-design');
