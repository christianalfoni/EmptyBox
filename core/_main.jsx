...
Page('/articles/2016_04_06_CycleJS-driven-by-state', function (req) {
  ...
  store.commit();
  require.ensure(['./../drafts/2016_04_06_CycleJS-driven-by-state.md'], function () {
    document.body.classList.remove('article-loading');
    var content = require('./../drafts/2016_04_06_CycleJS-driven-by-state.md');
